...
export class SingleTaskVerificationMarkdownComponent  {
  ...
  task: Task = {name: "Placeholder Name", description: "Placeholder Description", command: "Placeholder command", expected_output_value: "Expected Output", expected_return_code: 0, return_type: ReturnType.Return_Code_And_Text};
