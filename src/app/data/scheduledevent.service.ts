...
export class ScheduledeventService {
  ...
  private bh: BehaviorSubject<ScheduledEvent[]> = new BehaviorSubject(
    this.cachedSEList
  );
  ...
  public list(force = false) {
    if (!force && this.fetchedList) {
      ...
      return this.http.get(environment.server + '/a/scheduledevent/list').pipe(
  ...
  public get(id: string) {
    return this.http.get(environment.server + '/a/scheduledevent/' + id).pipe(
      switchMap((s: ServerResponse) => {
